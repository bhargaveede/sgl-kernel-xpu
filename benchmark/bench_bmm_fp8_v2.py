...
def calculate_diff(batch_size: int, m: int, k: int, n: int, input_dtype, mat2_dtype, res_dtype):
    ...
    torch_out = torch_bmm_fp8(input_fp8, mat2_fp8, input_inv_s, mat2_inv_s, res_dtype=res_dtype)
...
def benchmark_bmm_fp8(batch_size, m, k, n, provider):
    ...
    if provider == "torch":
        fn = lambda: torch_bmm_fp8(input_fp8, mat2_fp8, input_inv_s, mat2_inv_s, res_dtype)
